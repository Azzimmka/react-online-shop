        ...
        <div className="w-325 p-4 rounded-b-[40px] flex items-center justify-between mx-auto bg-cyan-800 text-white">
            ...
            <div className="flex items-center gap-5" >
                <div className="relative">
                    <p className="absolute font-bold text-gray-500 -right-3 -top-2 bg-white p-4 rounded-full w-2.5 h-2.5 flex items-center justify-center">{state.likes.length}</p>
